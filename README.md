...
|2|The Query Developer. Gil Guzman Guillermo|Constructor MQL. Traduce las preguntas de negocio ("¿Cuántos usuarios...?") a código MongoDB (db.collection.find(...)). Es quien más interactúa con la IA para optimizar filtros.
